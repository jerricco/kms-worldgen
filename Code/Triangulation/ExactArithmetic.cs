...
internal static class ExactArithmetic
{
	...
	// [MethodImplOptions(MethodImplOptions.AggressiveInlining)]
	public static void TwoProductPresplit(
		double a,
		double b,
		double bhi,
		double blo,
	...
	// This is TwoProduct for the case where one factor has already been Split
	// [MethodImplOptions(MethodImplOptions.AggressiveInlining)]
	public static void TwoProduct2Presplit(
		double a,
		double ahi,
		double alo,
		double b,
	...
	// [MethodImplOptions(MethodImplOptions.AggressiveInlining)]
	public static void FourFourSum(
		double a3,
		double a2,
		double a1,
		double a0,
	...
	// [MethodImplOptions(MethodImplOptions.AggressiveInlining)]
	public static void EightOneSum(
		double a7,
		double a6,
		double a5,
		double a4,
	...
	// [MethodImplOptions(MethodImplOptions.AggressiveInlining)]
	public static void EightTwoSum(
		double a7,
		double a6,
		double a5,
		double a4,
	...
	// [MethodImplOptions(MethodImplOptions.AggressiveInlining)]
	public static void EightFourSum(
		double a7,
		double a6,
		double a5,
		double a4,
	...
	// [MethodImplOptions(MethodImplOptions.AggressiveInlining)]
	public static void TwoOneProduct(
		double a1,
		double a0,
		double b,
		out double x3,
	...
	// [MethodImplOptions(MethodImplOptions.AggressiveInlining)]
	public static void FourOneProduct(
		double a3,
		double a2,
		double a1,
		double a0,
	...
	// [MethodImplOptions(MethodImplOptions.AggressiveInlining)]
	public static void TwoTwoProduct(
		double a1,
		double a0,
		double b1,
		double b0,
