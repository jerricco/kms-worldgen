...
public static class GeometricPredicates
{
	...
	/// <returns>
	/// a positive value if the points pa, pb, and pc occur
	...
	internal static double Orient2DExact(double[] pa, double[] pb, double[] pc)
	{
		...
		var aterms = new double[4];
		var bterms = new double[4];
		var cterms = new double[4];
	...
	internal static double Orient2DSlow(double[] pa, double[] pb, double[] pc)
	{
		...
		var axby = new double[8];
		var bxay = new double[8];
		double axby7, bxay7;
		var deter = new double[16];
		int deterlen;
	...
	private static double Orient2DAdapt(
		double pax,
		double pay,
		double pbx,
		double pby,
	...
	internal static double Orient3DExact(double[] pa, double[] pb, double[] pc, double[] pd)
	{
		...
		var adet = new double[24];
		var bdet = new double[24];
		var cdet = new double[24];
		var ddet = new double[24];
		int alen, blen, clen, dlen;
		var abdet = new double[48];
		var cddet = new double[48];
		int ablen, cdlen;
		var deter = new double[96];
		int deterlen;
		int i;
	...
	internal static double Orient3DSlow(double[] pa, double[] pb, double[] pc, double[] pd)
	{
		...
		var axby = new double[8];
		var bxcy = new double[8];
		var axcy = new double[8];
		var bxay = new double[8];
		var cxby = new double[8];
		var cxay = new double[8];
		var temp16 = new double[16];
		var temp32 = new double[32];
		var temp32t = new double[32];
		int temp16len, temp32len, temp32tlen;
		var adet = new double[64];
		var bdet = new double[64];
		var cdet = new double[64];
		int alen, blen, clen;
		var abdet = new double[128];
		int ablen;
		var deter = new double[192];
		int deterlen;
	...
	private static double Orient3DAdapt(double[] pa, double[] pb, double[] pc, double[] pd, double permanent)
	{
		...
		var ab = new double[4];
		double bc3, ca3, ab3;
		var adet = new double[8];
		var bdet = new double[8];
		var cdet = new double[8];
		int alen, blen, clen;
		var abdet = new double[16];
		int ablen;
		double[] finnow, finother, finswap;
		var fin1 = new double[192];
		...
		var at_b = new double[4];
		var at_c = new double[4];
		var bt_c = new double[4];
		var bt_a = new double[4];
		var ct_a = new double[4];
		var ct_b = new double[4];
		...
		var bct = new double[8];
		var cat = new double[8];
		var abt = new double[8];
		...
		if (adxtail != 0.0)
		{
			if (bdytail != 0.0)
			{
				...
				u[3] = u3;
				finlength = EA.FastExpansionSumZeroElim(
					finlength,
					finnow,
					4,
					u,
	...
	internal static double InCircleExact(double[] pa, double[] pb, double[] pc, double[] pd)
	{
		...
		var det24y = new double[24];
		var det48x = new double[48];
		var det48y = new double[48];
		int xlen, ylen;
		var adet = new double[96];
		var bdet = new double[96];
		var cdet = new double[96];
		var ddet = new double[96];
		int alen, blen, clen, dlen;
		var abdet = new double[192];
		var cddet = new double[192];
		int ablen, cdlen;
		var deter = new double[384];
		int deterlen;
		int i;
	...
	internal static double InCircleSlow(double[] pa, double[] pb, double[] pc, double[] pd)
	{
		...
		var temp16 = new double[16];
		int temp16len;
		var detx = new double[32];
		var detxx = new double[64];
		var detxt = new double[32];
		var detxxt = new double[64];
		var detxtxt = new double[64];
		int xlen, xxlen, xtlen, xxtlen, xtxtlen;
		var x1 = new double[128];
		var x2 = new double[192];
		int x1len, x2len;
		var dety = new double[32];
		var detyy = new double[64];
		var detyt = new double[32];
		var detyyt = new double[64];
		var detytyt = new double[64];
		int ylen, yylen, ytlen, yytlen, ytytlen;
		var y1 = new double[128];
		var y2 = new double[192];
		int y1len, y2len;
		var adet = new double[384];
		var bdet = new double[384];
		var cdet = new double[384];
		var abdet = new double[768];
		var deter = new double[1152];
	...
	private static double InCircleAdapt(double[] pa, double[] pb, double[] pc, double[] pd, double permanent)
	{
		...
		var ab = new double[4];
		double bc3, ca3, ab3;
		var axbc = new double[8];
		var axxbc = new double[16];
		var aybc = new double[8];
		var ayybc = new double[16];
		var adet = new double[32];
		int axbclen, axxbclen, aybclen, ayybclen, alen;
		var bxca = new double[8];
		var bxxca = new double[16];
		var byca = new double[8];
		var byyca = new double[16];
		var bdet = new double[32];
		int bxcalen, bxxcalen, bycalen, byycalen, blen;
		var cxab = new double[8];
		var cxxab = new double[16];
		var cyab = new double[8];
		var cyyab = new double[16];
		var cdet = new double[32];
		int cxablen, cxxablen, cyablen, cyyablen, clen;
		var abdet = new double[64];
		int ablen;
		var fin1 = new double[1152];
		...
		double u3, v3;
		var temp8 = new double[8];
		var temp16a = new double[16];
		var temp16b = new double[16];
		var temp16c = new double[16];
		var temp32a = new double[32];
		var temp32b = new double[32];
		var temp48 = new double[48];
		var temp64 = new double[64];
		int temp8len, temp16alen, temp16blen, temp16clen;
		int temp32alen, temp32blen, temp48len, temp64len;
		var axtbb = new double[8];
		var axtcc = new double[8];
		var aytbb = new double[8];
		var aytcc = new double[8];
		int axtbblen, axtcclen, aytbblen, aytcclen;
		var bxtaa = new double[8];
		var bxtcc = new double[8];
		var bytaa = new double[8];
		var bytcc = new double[8];
		int bxtaalen, bxtcclen, bytaalen, bytcclen;
		var cxtaa = new double[8];
		var cxtbb = new double[8];
		var cytaa = new double[8];
		var cytbb = new double[8];
		int cxtaalen, cxtbblen, cytaalen, cytbblen;
		var axtbc = new double[8];
		var aytbc = new double[8];
		var bxtca = new double[8];
		var bytca = new double[8];
		var cxtab = new double[8];
		var cytab = new double[8];
		int axtbclen, aytbclen, bxtcalen, bytcalen, cxtablen, cytablen;
		var axtbct = new double[16];
		var aytbct = new double[16];
		var bxtcat = new double[16];
		var bytcat = new double[16];
		var cxtabt = new double[16];
		var cytabt = new double[16];
		int axtbctlen, aytbctlen, bxtcatlen, bytcatlen, cxtabtlen, cytabtlen;
		var axtbctt = new double[8];
		var aytbctt = new double[8];
		var bxtcatt = new double[8];
		var bytcatt = new double[8];
		var cxtabtt = new double[8];
		var cytabtt = new double[8];
		int axtbcttlen, aytbcttlen, bxtcattlen, bytcattlen, cxtabttlen, cytabttlen;
		var abt = new double[8];
		var bct = new double[8];
		var cat = new double[8];
		int abtlen, bctlen, catlen;
		var abtt = new double[4];
		var bctt = new double[4];
		var catt = new double[4];
	...
	internal static double InSphereSlow(double[] pa, double[] pb, double[] pc, double[] pd, double[] pe)
	{
		...
		var axby = new double[8];
		var bxcy = new double[8];
		var cxdy = new double[8];
		var dxay = new double[8];
		var axcy = new double[8];
		var bxdy = new double[8];
		var bxay = new double[8];
		var cxby = new double[8];
		var dxcy = new double[8];
		var axdy = new double[8];
		var cxay = new double[8];
		var dxby = new double[8];
		var ab = new double[16];
		var bc = new double[16];
		var cd = new double[16];
		var da = new double[16];
		var ac = new double[16];
		var bd = new double[16];
		int ablen, bclen, cdlen, dalen, aclen, bdlen;
		var temp32a = new double[32];
		var temp32b = new double[32];
		var temp64a = new double[64];
		var temp64b = new double[64];
		var temp64c = new double[64];
		int temp32alen, temp32blen, temp64alen, temp64blen, temp64clen;
		var temp128 = new double[128];
		var temp192 = new double[192];
		int temp128len, temp192len;
		var detx = new double[384];
		var detxx = new double[768];
		var detxt = new double[384];
		var detxxt = new double[768];
		var detxtxt = new double[768];
		int xlen, xxlen, xtlen, xxtlen, xtxtlen;
		var x1 = new double[1536];
		var x2 = new double[2304];
		int x1len, x2len;
		var dety = new double[384];
		var detyy = new double[768];
		var detyt = new double[384];
		var detyyt = new double[768];
		var detytyt = new double[768];
		int ylen, yylen, ytlen, yytlen, ytytlen;
		var y1 = new double[1536];
		var y2 = new double[2304];
		int y1len, y2len;
		var detz = new double[384];
		var detzz = new double[768];
		var detzt = new double[384];
		var detzzt = new double[768];
		var detztzt = new double[768];
		int zlen, zzlen, ztlen, zztlen, ztztlen;
		var z1 = new double[1536];
		var z2 = new double[2304];
		int z1len, z2len;
		var detxy = new double[4608];
		int xylen;
		var adet = new double[6912];
		var bdet = new double[6912];
		var cdet = new double[6912];
		var ddet = new double[6912];
		int alen, blen, clen, dlen;
		var abdet = new double[13824];
		var cddet = new double[13824];
		var deter = new double[27648];
		int deterlen;
		int i;
	...
	private static double InSphereAdapt(
		double[] pa,
		double[] pb,
		double[] pc,
		double[] pd,
	...
	)
	{
		...
		var temp8a = new double[8];
		var temp8b = new double[8];
		var temp8c = new double[8];
		var temp16 = new double[16];
		var temp24 = new double[24];
		var temp48 = new double[48];
		int temp8alen, temp8blen, temp8clen, temp16len, temp24len, temp48len;
		var xdet = new double[96];
		var ydet = new double[96];
		var zdet = new double[96];
		var xydet = new double[192];
		int xlen, ylen, zlen, xylen;
		var adet = new double[288];
		var bdet = new double[288];
		var cdet = new double[288];
		var ddet = new double[288];
		int alen, blen, clen, dlen;
		var abdet = new double[576];
		var cddet = new double[576];
		int ablen, cdlen;
		var fin1 = new double[1152];
		int finlength;
